...
From the result presented in the above-figure we can fairly conclude that the ....... The high correlation *R* = `r round(cor.test(iris$Petal.Length,iris$Petal.Width)$estimate,2)` is a highly significant (*p* = `r round(cor.test(iris$Petal.Length,iris$Petal.Width)$p.value,4)`) obvious evidence of causality. <br/>
Note that both my *R* and *p* values come in R code embeded within the text. <br/>
